...
Info
    A validator for the gen_gtkmm bundle.
'''
...
class GenGtkmmBundleValidator:
    '''
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_gtkmm bundle.
                | is_valid - Checks if the gen_gtkmm bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenGtkmmBundle) -> None:
        '''
            Validates the gen_gtkmm bundle.

            :param bundle: The gen_gtkmm bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_gtkmm_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_gtkmm bundle must be provided'
        msg_bundle_istype: str = 'the gen_gtkmm bundle must be an instance of GenGtkmmBundle'
        ...
        istype(bundle, GenGtkmmBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, gengtkmmbundle: GenGtkmmBundle) -> bool:
        '''
            Checks if the gengtkmmbundle is valid.

            :param gengtkmmbundle: The gengtkmmbundle to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(gengtkmmbundle)
            return True
