...
Info
    Validator for the gen_gtkmm bundle dependencies.
'''
...
class GenGtkmmBundleDependenciesValidator:
    '''
        Validator for the gen_gtkmm bundle dependencies.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_gtkmm bundle dependencies.
                | is_valid - Checks if the gen_gtkmm bundle dependencies is valid.
    '''

    @classmethod
    def validate(cls, dependencies: GenGtkmmBundleDependencies) -> None:
        '''
            Validates the gen_gtkmm bundle dependencies.

            :param dependencies: The gen_gtkmm bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_gtkmm_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_gtkmm bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_gtkmm bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenGtkmmBundleKeys.get_dependency_to_type().items():
    ...
    @classmethod
    def is_valid(cls, gengtkmmbundledependencies: GenGtkmmBundleDependencies) -> bool:
        '''
            Checks if the gengtkmmbundledependencies is valid.

            :param gengtkmmbundledependencies: The gengtkmmbundledependencies to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(gengtkmmbundledependencies)
            return True
