...
Info
    GenGtkmm bundle dependencies for the gen_gtkmm bundle.
'''
...
class GenGtkmmBundleDependencies(TypedDict):
    '''
        GenGtkmm bundle dependencies for the gen_gtkmm bundle.
        ...
        It defines:
            ...
            :attributes:
                | base - The base bundle with the base components for the gen_gtkmm bundle.
                | service - The service orchestrating the gen_gtkmm's execution for the gen_gtkmm bundle.
                | subprocessor - The adapter executing the gen_gtkmm's sub-processes for the gen_gtkmm bundle.
                | cli - The command-line interface adapter for the gen_gtkmm bundle.
    '''
