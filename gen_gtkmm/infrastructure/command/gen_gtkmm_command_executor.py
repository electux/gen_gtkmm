...
Info
    Defines GenGtkmmCommandExecutor class.
'''
...
class GenGtkmmCommandExecutor:
    '''
        Command executor strategy for generating gtkmm project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenGtkmmCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenGtkmmCommandExecutor as string representation.

            :return: The GenGtkmmCommandExecutor as string representation.
        '''
        return to_str(self)
