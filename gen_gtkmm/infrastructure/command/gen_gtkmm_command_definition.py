...
Info
    Defines GenGtkmmCommandDefinition class.
'''
...
class GenGtkmmCommandDefinition:
    '''
        CLI subcommand metadata definition for gtkmm project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate Gtkmm project skeleton'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            ...
            OptionData(
                name="--type",
                help_text="gtkmm version (gtkmm3 | gtkmm4)",
                action=None,
                default="gtkmm4",
                required=True,
                choices=["gtkmm3", "gtkmm4"],
                nargs=None
            ),
            OptionData(
                name="--output",
