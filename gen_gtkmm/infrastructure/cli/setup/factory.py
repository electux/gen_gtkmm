...
from gen_gtkmm.infrastructure.cli.setup.options import CLIBundleOptions
from gen_gtkmm.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_gtkmm.infrastructure.cli.setup.bundle import CLIBundle
from gen_gtkmm.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_gtkmm.infrastructure.command.icommand_definition import ICommandDefinition
from gen_gtkmm.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenGtkmmCommandDefinition()
        service_executor: ICommandExecutor = GenGtkmmCommandExecutor(definition=service_definition)
