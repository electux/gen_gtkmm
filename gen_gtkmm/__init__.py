...
Info
    Defines class GenGtkMM with attribute(s) and method(s).
...
class GenGtkMM(ATSCli):
    '''
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initials GenGtkMM constructor.
                | process - Processes and runs operations.
    '''

    _GEN_VERBOSE: str = 'GEN_GTKMM'
    ...
    def __init__(self, verbose: bool = False) -> None:
        ...
        gen_esp_property: Dict[str, str | bool] = {
