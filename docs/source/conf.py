...
htmlhelp_basename: str = 'gen_gtkmmdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_gtkmm.tex', 'gen\\_autoconf Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_gtkmm', 'gen_gtkmm Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_gtkmm', 'gen_gtkmm Documentation', author,
    'gen_gtkmm', 'One line description of project.', 'Miscellaneous'
)]
