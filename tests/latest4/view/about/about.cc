...
AppAbout::AppAbout()
{
    set_program_name("latest4");
    set_version("1.0.0");
    set_copyright("Vladimir Roncevic <elektron.ronca@gmail.com>");
    set_comments("This is latest4 application.");
    set_license("GPLv3");
    set_website("https://electux.github.io/latest4");
    set_website_label("electux.github.io/latest4");
