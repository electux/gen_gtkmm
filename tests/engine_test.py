...
Module
    test_engine.py
Info
    Unit tests for GenGtkmm engine.
'''
...
class TestGenGtkmm(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_gtkmm/infrastructure/config/gen_gtkmm.cfg',
                use_generator=True,
    ...
    @patch('gen_gtkmm.setup.validator.GenGtkmmBundleValidator.validate')
    ...
    def test_cli_bundle_factory(self) -> None:
        from gen_gtkmm.infrastructure.cli.setup.factory import CLIBundleFactory
